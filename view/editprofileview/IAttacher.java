...
public interface IAttacher {
    ...
    void setFlingAnimation(boolean animate);
    ...
    void setOnScaleEndListener(OnScaleEndListener listener);

    void setOnTouchUpListener(OnTouchUpListener listener);

    void setOnTouchDownListener(OnTouchDownListener listener);
