...
public class PhotoDraweeView extends SimpleDraweeView implements IAttacher {
    ...
    @Override public void setFlingAnimation(boolean animate){
        mAttacher.setFlingAnimation(animate);
    }
    ...
    @Override public void setOnScaleEndListener(OnScaleEndListener listener) {
        mAttacher.setOnScaleEndListener(listener);
    }

    @Override public void setOnDragListener(com.tozmart.tozisdk.view.editprofileview.OnDragListener listener) {
        mAttacher.setOnDragListener(listener);
    }

    @Override public void setOnMoveListener(OnMoveListener listener) {
        mAttacher.setOnMoveListener(listener);
    }

    @Override public void setOnTouchUpListener(OnTouchUpListener listener) {
        mAttacher.setOnTouchUpListener(listener);
    }

    @Override public void setOnTouchDownListener(OnTouchDownListener listener) {
        mAttacher.setOnTouchDownListener(listener);
    }
